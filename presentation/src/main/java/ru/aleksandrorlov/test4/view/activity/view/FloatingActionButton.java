package ru.aleksandrorlov.test4.view.activity.view;
...
public class FloatingActionButton extends View {
    ...
    public void setFloatingActionButtonDrawable(Drawable FloatingActionButtonDrawable) {
        bitmap = ((BitmapDrawable) FloatingActionButtonDrawable).getBitmap();
        invalidate();
    }
    ...
    public void init(int FloatingActionButtonColor) {
        ...
        buttonPaint.setColor(FloatingActionButtonColor);
        buttonPaint.setStyle(Paint.Style.FILL);
        buttonPaint.setShadowLayer(10.0f, 0.0f, 3.5f, Color.argb(100, 0, 0, 0));
    ...
    protected void onDraw(Canvas canvas) {
        setClickable(true);
        canvas.drawCircle(getWidth() / 2, getHeight() / 2, (float) (getWidth() / 2.6), buttonPaint);
